...
![主页面](resources/demo1.png)
![demo1-dark.png](resources/demo1-dark.png)

|                文件夹                |             搜索             |             主题             |
|:---------------------------------:|:--------------------------:|:--------------------------:|
| ![demo6.png](resources/demo6.png) | ![搜索](resources/demo3.png) | ![搜索](resources/demo4.png) |



|                背景                 |               AI设置                |            快捷键             |
|:---------------------------------:|:---------------------------------:|:--------------------------:|
| ![demo2.png](resources/demo2.png) | ![demo5.png](resources/demo5.png) | ![搜索](resources/demo7.png) |
...
|:---|:---|
| `Cmd+Opt+A` | 唤起 / 隐藏主窗口 |
| `Shift+Opt+Cmd+A` | 强制居中窗口（全局，隐藏时也可触发） |
| `Cmd+N` | 新建笔记 |
| `Cmd+F` | 搜索笔记 |
| `Cmd+[` / `Cmd+]` | 切换上 / 下一条笔记 |
